...
| Auth-service  |  Autenticacion JWT (login/refresh) | https://github.com/yuliethtrujillo01/oauth2-springboot.git | http://<ip-o-dominio>:8083 | http://<ip-o-dominio>:8083/swagger-ui | Yulieth Trujillo (yuliethtrujillo01) | En progreso   |
| Front-end |  interfaz gráfica y experiencia de uso | https://github.com/saramalaver01-cpu/front-end.git | http://<ip-o-dominio>:8083 | http://<ip-o-dominio>:8083/swagger-ui | Sara Malaver (saramalaver01-cpu) | Listo   |
